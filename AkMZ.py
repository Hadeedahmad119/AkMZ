...
__author__ = 'Ak MZ'
__copyright = 'All rights reserved . Copyright  Ak MZ'
...
def reg():
    ...
    if to in r:
        ...
        print ' \x1b[1;92mCopy the id and send to Ak MZ'
        print ' \x1b[1;92mYour id: ' + to
        raw_input('\x1b[1;93m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/AkMZ.zeshi')
        reg()
...
def n_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80AkMZ\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
